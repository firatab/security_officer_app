...
Patrol _$PatrolFromJson(Map json) => $checkedCreate(
      'Patrol',
      json,
      ($checkedConvert) {
        final val = Patrol(
          ...
          checkpoints: $checkedConvert(
              ...
              (v) => (v as List<dynamic>)
                  .map((e) =>
                      Checkpoint.fromJson(Map<String, dynamic>.from(e as Map)))
                  .toList()),
        );
        return val;
      },
...
Checkpoint _$CheckpointFromJson(Map json) => $checkedCreate(
      'Checkpoint',
      json,
      ($checkedConvert) {
