...
PatrolTaskModel _$PatrolTaskModelFromJson(Map json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = PatrolTaskModel(
          ...
          sortOrder:
              $checkedConvert('sortOrder', (v) => (v as num?)?.toInt() ?? 0),
      ...
      ($checkedConvert) {
        final val = PatrolPointModel(
          ...
          sequenceNumber: $checkedConvert(
              'sequenceNumber', (v) => (v as num?)?.toInt() ?? 0),
          requireScan:
              $checkedConvert('requireScan', (v) => v as bool? ?? true),
          requirePhoto:
              $checkedConvert('requirePhoto', (v) => v as bool? ?? false),
          requireNotes:
              $checkedConvert('requireNotes', (v) => v as bool? ?? false),
          instructions: $checkedConvert('instructions', (v) => v as String?),
          expectedDuration: $checkedConvert(
              'expectedDuration', (v) => (v as num?)?.toInt() ?? 5),
          isActive: $checkedConvert('isActive', (v) => v as bool? ?? true),
          ...
          geofenceRadius: $checkedConvert(
              'geofenceRadius', (v) => (v as num?)?.toInt() ?? 50),
          tasks: $checkedConvert(
              'tasks',
              (v) => (v as List<dynamic>?)
                  ?.map((e) => PatrolTaskModel.fromJson(
...
PatrolTourModel _$PatrolTourModelFromJson(Map json) => $checkedCreate(
      'PatrolTourModel',
      json,
      ($checkedConvert) {
        final val = PatrolTourModel(
          ...
          frequencyType: $checkedConvert(
              'frequencyType', (v) => v as String? ?? 'per_shift'),
          intervalMinutes:
              $checkedConvert('intervalMinutes', (v) => (v as num?)?.toInt()),
          scheduledTimes: $checkedConvert('scheduledTimes',
              (v) => (v as List<dynamic>?)?.map((e) => e as String).toList()),
          startTime: $checkedConvert('startTime', (v) => v as String?),
          endTime: $checkedConvert('endTime', (v) => v as String?),
          sequenceRequired:
              $checkedConvert('sequenceRequired', (v) => v as bool? ?? false),
          estimatedDuration:
              $checkedConvert('estimatedDuration', (v) => (v as num?)?.toInt()),
          isActive: $checkedConvert('isActive', (v) => v as bool? ?? true),
          syncedAt: $checkedConvert('syncedAt',
          ...
          points: $checkedConvert(
              'points',
              (v) => (v as List<dynamic>?)
                  ?.map((e) => PatrolPointModel.fromJson(
                      Map<String, dynamic>.from(e as Map)))
                  .toList()),
        );
        return val;
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = PatrolTaskResponseModel(
          ...
          tenantId: $checkedConvert('tenantId', (v) => v as String),
          pointCompletionId:
              $checkedConvert('pointCompletionId', (v) => v as String),
...
PatrolPointCompletionModel _$PatrolPointCompletionModelFromJson(Map json) =>
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = PatrolPointCompletionModel(
          ...
          tenantId: $checkedConvert('tenantId', (v) => v as String),
          patrolInstanceId:
              $checkedConvert('patrolInstanceId', (v) => v as String),
          patrolPointId: $checkedConvert('patrolPointId', (v) => v as String),
          arrivedAt: $checkedConvert('arrivedAt',
              (v) => v == null ? null : DateTime.parse(v as String)),
          completedAt: $checkedConvert('completedAt',
              (v) => v == null ? null : DateTime.parse(v as String)),
          duration: $checkedConvert('duration', (v) => (v as num?)?.toInt()),
          scanVerified:
              $checkedConvert('scanVerified', (v) => v as bool? ?? false),
          scanMethod: $checkedConvert('scanMethod', (v) => v as String?),
          latitude: $checkedConvert('latitude', (v) => (v as num?)?.toDouble()),
          longitude:
              $checkedConvert('longitude', (v) => (v as num?)?.toDouble()),
          withinGeofence:
              $checkedConvert('withinGeofence', (v) => v as bool? ?? true),
          photoLocalPath:
              $checkedConvert('photoLocalPath', (v) => v as String?),
          ...
          taskResponses: $checkedConvert(
              'taskResponses',
              (v) => (v as List<dynamic>?)
                  ?.map((e) => PatrolTaskResponseModel.fromJson(
                      Map<String, dynamic>.from(e as Map)))
                  .toList()),
        );
        return val;
...
PatrolInstanceModel _$PatrolInstanceModelFromJson(Map json) => $checkedCreate(
      'PatrolInstanceModel',
      json,
      ($checkedConvert) {
        final val = PatrolInstanceModel(
          ...
          scheduledStart: $checkedConvert('scheduledStart',
              (v) => v == null ? null : DateTime.parse(v as String)),
          actualStart: $checkedConvert('actualStart',
              (v) => v == null ? null : DateTime.parse(v as String)),
          actualEnd: $checkedConvert('actualEnd',
              (v) => v == null ? null : DateTime.parse(v as String)),
          status: $checkedConvert('status', (v) => v as String? ?? 'pending'),
          totalPoints:
              $checkedConvert('totalPoints', (v) => (v as num?)?.toInt() ?? 0),
          completedPoints: $checkedConvert(
              'completedPoints', (v) => (v as num?)?.toInt() ?? 0),
          startLatitude:
              $checkedConvert('startLatitude', (v) => (v as num?)?.toDouble()),
          startLongitude:
              $checkedConvert('startLongitude', (v) => (v as num?)?.toDouble()),
          notes: $checkedConvert('notes', (v) => v as String?),
          needsSync: $checkedConvert('needsSync', (v) => v as bool? ?? false),
          syncedAt: $checkedConvert('syncedAt',
              (v) => v == null ? null : DateTime.parse(v as String)),
          ...
          patrolTour: $checkedConvert(
              ...
              (v) => v == null
                  ? null
                  : PatrolTourModel.fromJson(
                      Map<String, dynamic>.from(v as Map))),
          pointCompletions: $checkedConvert(
              'pointCompletions',
              (v) => (v as List<dynamic>?)
                  ?.map((e) => PatrolPointCompletionModel.fromJson(
                      Map<String, dynamic>.from(e as Map)))
                  .toList()),
        );
        return val;
...
Map<String, dynamic> _$PatrolInstanceModelToJson(
    ...
    <String, dynamic>{
      ...
      'pointCompletions':
          instance.pointCompletions?.map((e) => e.toJson()).toList(),
    };

PatrolScheduleModel _$PatrolScheduleModelFromJson(Map json) => $checkedCreate(
      'PatrolScheduleModel',
      json,
      ($checkedConvert) {
        final val = PatrolScheduleModel(
          ...
          scheduledDate: $checkedConvert(
              'scheduledDate', (v) => DateTime.parse(v as String)),
