...
ShiftModel _$ShiftModelFromJson(Map json) => $checkedCreate(
      'ShiftModel',
      json,
      ($checkedConvert) {
...
SiteModel _$SiteModelFromJson(Map json) => $checkedCreate(
      'SiteModel',
      json,
      ($checkedConvert) {
        final val = SiteModel(
          ...
          checkCallEnabled:
              $checkedConvert('checkCallEnabled', (v) => v as bool? ?? false),
          checkCallFrequency:
              $checkedConvert('checkCallFrequency', (v) => _parseInt(v)),
        );
        return val;
      },
    );
...
ClientModel _$ClientModelFromJson(Map json) => $checkedCreate(
      'ClientModel',
      json,
      ($checkedConvert) {
...
AttendanceModel _$AttendanceModelFromJson(Map json) => $checkedCreate(
      'AttendanceModel',
      json,
      ($checkedConvert) {
        final val = AttendanceModel(
          id: $checkedConvert('id', (v) => v as String),
          bookOnTime: $checkedConvert('bookOnTime',
              (v) => v == null ? null : DateTime.parse(v as String)),
          bookOffTime: $checkedConvert('bookOffTime',
              (v) => v == null ? null : DateTime.parse(v as String)),
          status: $checkedConvert('status', (v) => v as String),
